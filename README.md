...
The theoretical framing connects defect vocabulary and a Natural/Artificial
semantic axis to cultural-field theories of legitimate versus illegitimate
production in expert valuation.
...
Week notebooks remain in `notebooks/` for step-by-step reproduction. Publication tables
